...
| [53 - Installability and Linux compatibility v0](53-installability-linux-compatibility-v0.md) | Contratto e roadmap per installazione staged, layout posseduto da Alfred, matrice Linux userspace e futura copertura di kernel reali senza confondere container e VM. | Maintainer, contributori packaging/CI, studenti e agenti AI. | Dopo l'MVP documentato e prima di aggiungere target `install`, distro CI, VM, kernel specifici o nuovi strumenti di quality engineering. |
| [54 - Audit installazione e assunzioni CI v0](54-audit-installazione-ci-v0.md) | Fotografia verificata di artefatti debug/release, man page installabili, dipendenze delle suite, limiti della CI e requisiti minimi del futuro stage install. | Maintainer, contributori packaging/CI, studenti e reviewer del Makefile. | Prima di implementare `PREFIX`, `DESTDIR`, `install`, `uninstall` o una matrice di distribuzioni. |
