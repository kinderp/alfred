...
| 12 | [MVP operational usability v0](49-mvp-operational-usability-v0.md) | in progress | 2026-07-17 -> 2026-07-24 UTC | Circa 1 settimana | In corso | Dopo la decisione raw-first sul core input model non conviene riaprire subito il percorso caldo o partire con nuovi backend. Il rischio piu' vicino e' operativo: l'MVP esiste, ma un utente deve ancora capire facilmente CLI, config, log, JSONL e smoke test. | Inotify reference backend MVP closure audit, Core Input Model / Main Loop Migration v0, Event Model v0, Backend API v0 staged, Writer Runtime v0, JSONL/session metadata. | CLI minima piu' chiara, README e man page allineati, smoke test MVP, readiness operativa e base piu' solida prima di fanotify/eBPF/audit o Agent Guard. Rimandati: nuovi backend, policy/enforcement, worker thread, core record-first e Universal Observation Runtime. | [Milestone #12](https://github.com/kinderp/alfred/milestone/12), [Issue #209](https://github.com/kinderp/alfred/issues/209) | [49](49-mvp-operational-usability-v0.md), [19](19-roadmap-cli-e-man-page.md), [26](26-stato-funzionalita.md), [48](48-core-input-main-loop-migration-v0.md), [README](../../README.md), [man](../man/man1/alfred.1) |
