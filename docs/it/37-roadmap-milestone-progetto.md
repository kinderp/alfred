...
| 15 | [Installability and Linux compatibility v0](53-installability-linux-compatibility-v0.md) | in progress | 2026-07-18 -> 2026-07-25 UTC | Circa 1 settimana | In corso | L'MVP, la CLI e la documentazione sono stabili, ma manca ancora un contratto di installazione e non esiste evidenza onesta su piu' distribuzioni o kernel Linux. | Post-MVP documentation and man pages v0, CLI parser v0, smoke test MVP, Makefile e CI correnti. | Packaging futuro, primi utenti esterni, matrice userspace ripetibile e basi per successive corsie VM/kernel, analisi statica e fuzzing. | [Milestone #15](https://github.com/kinderp/alfred/milestone/15), [Issue #261](https://github.com/kinderp/alfred/issues/261), [Issue #262](https://github.com/kinderp/alfred/issues/262) | [53](53-installability-linux-compatibility-v0.md), [09](09-makefile-e-build-system.md), [10](10-debugging-test-e-strumenti.md), [35](35-qualita-prodotto-software.md), [51](51-post-mvp-documentation-man-pages-v0.md) |
