...
| 13 | [CLI parser v0](50-cli-parser-v0.md) | in progress | 2026-07-17 -> 2026-07-24 UTC | Circa 1 settimana | In corso | Dopo la readiness MVP, il debito utente piu' vicino e' il parsing esplicito degli argomenti. `-c`, `--config`, `--print-config` e `--` non devono restare path accidentali o promesse vaghe nella documentazione. | MVP operational usability v0, roadmap CLI/man page, livello applicazione, test CLI. | CLI piu' prevedibile, config precedence testata, README/man page piu' affidabili e base migliore per packaging/uso reale senza riaprire hot path o backend futuri. Rimandati: subcommand framework, daemon mode, Agent Guard, backend futuri e installazione man page. | [Milestone #13](https://github.com/kinderp/alfred/milestone/13), [Issue #228](https://github.com/kinderp/alfred/issues/228) | [50](50-cli-parser-v0.md), [19](19-roadmap-cli-e-man-page.md), [49](49-mvp-operational-usability-v0.md), [04](04-livello-applicazione.md), [README](../../README.md), [README.it](../../README.it.md) |
