...
| 2 | [Backend API v0 implementation](30-backend-api-v0.md) | planned | 2026-06-29 -> 2026-07-06 | Circa 1 settimana | Non ancora nota | Serve rendere reale il confine backend-agnostic: lifecycle, target, capabilities, error model e adapter senza far dipendere il core da inotify. | Inotify reference backend, Event Model v0, Writer Runtime v0. | Backend fanotify/audit/eBPF futuri, capabilities runtime, policy che degrada in base al backend. | [Milestone #2](https://github.com/kinderp/alfred/milestone/2), [Issue #45](https://github.com/kinderp/alfred/issues/45), [Discussion #44](https://github.com/kinderp/alfred/discussions/44) | [23](23-roadmap-plugin-backend.md), [25](25-roadmap-unificata-dossier.md), [39](39-principi-architetturali-futuri.md) |
