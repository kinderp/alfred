...
| 5 | [Performance suite v0](34-report-benchmark-prestazioni.md) | in progress | 2026-07-13 -> 2026-07-20 UTC | Circa 1 settimana | Non ancora nota | Le scelte di queue, writer, JSONL e futuri backend devono essere guidate da numeri, non da sensazioni. Dopo Writer Runtime v0 e Lab MVP serve stabilizzare cosa misuriamo prima di riaprire thread, code per sink o formati futuri. | Writer Runtime v0, benchmark iniziali, output counter/JSONL, runtime output opt-in. | Decisioni su worker, per-sink queues, buffering, binary writer, hot path e futuri benchmark backend. | [Milestone #5](https://github.com/kinderp/alfred/milestone/5), [Issue #115](https://github.com/kinderp/alfred/issues/115), [Issue #116](https://github.com/kinderp/alfred/issues/116) | [33](33-writer-runtime-roadmap-v0.md), [34](34-report-benchmark-prestazioni.md), [35](35-qualita-prodotto-software.md) |
