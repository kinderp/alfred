...
| 2 | [Backend API v0 implementation](30-backend-api-v0.md) | in progress | 2026-06-29 -> 2026-07-06 | Circa 1 settimana | Non ancora nota | Serve rendere reale il confine backend-agnostic: lifecycle, target, capabilities, error model e adapter senza far dipendere il core da inotify. La migrazione del main loop a `backend_ops->poll()` e' stata separata perche' il core consuma ancora `alfred_raw_event_t`, mentre la poll staged emette `alfred_record_t`. | Inotify reference backend, Event Model v0, Writer Runtime v0. | Backend fanotify/audit/eBPF futuri, capabilities runtime, policy che degrada in base al backend. | [Milestone #2](https://github.com/kinderp/alfred/milestone/2), [Issue #45](https://github.com/kinderp/alfred/issues/45), [Issue #67](https://github.com/kinderp/alfred/issues/67), [Discussion #44](https://github.com/kinderp/alfred/discussions/44) | [23](23-roadmap-plugin-backend.md), [25](25-roadmap-unificata-dossier.md), [39](39-principi-architetturali-futuri.md) |
| 3 | [Inotify backend conforms to Backend API v0](30-backend-api-v0.md) | planned | Da definire dopo Backend API v0 | Da stimare | Non ancora nota | Dopo aver definito l'API comune, inotify deve diventare il primo backend conforme senza cambiare il comportamento utente. | Backend API v0 implementation. | Primo backend sostituibile, registry backend, capabilities reali, test di conformita'. | Da creare. | [05](05-modulo-inotify.md), [31](31-milestone-inotify-reference-backend.md) |
| 4 | [Tracepoint and Lab MVP](25-roadmap-unificata-dossier.md) | planned | Da definire | Da stimare | Non ancora nota | Alfred deve diventare spiegabile: test, studenti e demo hanno bisogno di tracepoint stabili e scenari leggibili. | Event Model v0, Writer Runtime v0, JSONL stabile, Backend API v0 almeno avviata. | Alfred Lab, demo pubbliche, documentazione animabile, debugging piu' chiaro. | Da creare. | [17](17-roadmap-documentazione-avanzata.md), [16](16-mappa-codice-e-strutture.md) |
| 5 | [Performance suite v0](34-report-benchmark-prestazioni.md) | planned | Da definire | Da stimare | Non ancora nota | Le scelte di queue, writer, JSONL e futuri backend devono essere guidate da numeri, non da sensazioni. | Writer Runtime v0, benchmark iniziali, output counter/JSONL. | Decisioni su worker, per-sink queues, buffering, binary writer e hot path. | Da creare. | [33](33-writer-runtime-roadmap-v0.md), [35](35-qualita-prodotto-software.md) |
