...
| 3 | [Inotify backend conforms to Backend API v0](31-milestone-inotify-reference-backend.md) | in progress | 2026-07-02 -> 2026-07-08 | Circa 1 settimana | Non ancora nota | Dopo aver definito l'API comune, inotify deve diventare il primo backend conforme senza cambiare il comportamento utente. Il primo passo e' un audit esplicito dei gap tra implementazione inotify corrente e Backend API v0 staged subset. | Backend API v0 implementation. | Primo backend sostituibile, registry backend, capabilities reali, test di conformita' e base piu' chiara per fanotify/audit/eBPF futuri. | [Milestone #3](https://github.com/kinderp/alfred/milestone/3), [Issue #71](https://github.com/kinderp/alfred/issues/71), [Issue #72](https://github.com/kinderp/alfred/issues/72), [Issue #73](https://github.com/kinderp/alfred/issues/73), [PR #74](https://github.com/kinderp/alfred/pull/74) | [05](05-modulo-inotify.md), [30](30-backend-api-v0.md), [31](31-milestone-inotify-reference-backend.md) |
