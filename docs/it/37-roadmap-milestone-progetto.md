...
| 16 | [First-user pre-release validation](audit/README.md) | planned | Dopo il merge di PR #277; data orientativa da assegnare all'apertura | Circa 1 settimana iniziale | Non ancora nota | Dopo installabilita', CLI, documentazione e CI serve osservare uso reale prima di scegliere altra architettura o feature. | Installability and Linux compatibility v0, smoke MVP, audit notturni e chiusura debito CI #276. | Bug report riproducibili, priorita' guidate da utenti, scenari reali e decisione sulla feature successiva. | GitHub Milestone e issue madre da creare dopo il merge di PR #277. | [Audit](audit/README.md), [53](53-installability-linux-compatibility-v0.md), [35](35-qualita-prodotto-software.md) |
