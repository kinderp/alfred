...
| 9 | [Metadata/session record JSONL v0](46-metadata-session-record-jsonl-v0.md) | in progress | 2026-07-14 -> 2026-07-20 UTC | Circa 1 settimana | In corso | Dopo il contesto runtime workspace/sessione serve il primo output pubblico controllato. Il passo corretto e' un record metadata/sessione separato, non enrichment per-evento, cosi' evitiamo copie stringa e ambiguita' di attribuzione. | Workspace/session runtime context v0, Workspace/session runtime schema v0, Event Model v0, Writer Runtime v0, Performance suite v0. | Golden JSONL per contesto sessione, ledger observe-mode piu' utile, futura integrazione Agent Action Ledger senza promettere policy o process attribution. Rimandati: agent session, process tree, policy, id generation, per-event enrichment. | [Milestone #9](https://github.com/kinderp/alfred/milestone/9), [Issue #163](https://github.com/kinderp/alfred/issues/163), [Issue #164](https://github.com/kinderp/alfred/issues/164) | [46](46-metadata-session-record-jsonl-v0.md), [45](45-workspace-session-runtime-context-v0.md), [44](44-workspace-session-runtime-schema-v0.md), [29](29-event-model-v0.md), [34](34-report-benchmark-prestazioni.md) |
