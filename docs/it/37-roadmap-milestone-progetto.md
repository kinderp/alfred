...
| 12 | [MVP operational usability v0](49-mvp-operational-usability-v0.md) | ready to close | 2026-07-17 -> 2026-07-17 UTC | Circa 1 settimana | Circa 1 giorno | Dopo la decisione raw-first sul core input model non conveniva riaprire subito il percorso caldo o partire con nuovi backend. Il rischio piu' vicino era operativo: l'MVP esisteva, ma un utente doveva ancora capire facilmente CLI, config, log, JSONL e smoke test. La milestone chiude quel gap senza cambiare runtime. | Inotify reference backend MVP closure audit, Core Input Model / Main Loop Migration v0, Event Model v0, Backend API v0 staged, Writer Runtime v0, JSONL/session metadata. | CLI minima documentata e testata, README e man page inglesi allineati, README/man page italiane locali, smoke test MVP, readiness audit e base piu' solida prima di fanotify/eBPF/audit o Agent Guard. Rimandati: parser CLI completo, packaging man page, nuovi backend, policy/enforcement, worker thread, core record-first e Universal Observation Runtime. | [Milestone #12](https://github.com/kinderp/alfred/milestone/12), [Issue #209](https://github.com/kinderp/alfred/issues/209), [Issue #224](https://github.com/kinderp/alfred/issues/224) | [49](49-mvp-operational-usability-v0.md), [19](19-roadmap-cli-e-man-page.md), [26](26-stato-funzionalita.md), [48](48-core-input-main-loop-migration-v0.md), [README](../../README.md), [README.it](../../README.it.md), [man](../man/man1/alfred.1) |
