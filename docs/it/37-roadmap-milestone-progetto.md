...
| 11 | [Core Input Model / Main Loop Migration v0](48-core-input-main-loop-migration-v0.md) | in progress | 2026-07-16 -> 2026-07-24 UTC | Circa 1 settimana | In corso | Dopo la chiusura MVP del backend inotify resta un debito centrale: il main loop usa ancora il ponte raw verso il core, mentre la Backend API v0 staged emette record normalizzati. Prima di introdurre backend futuri bisogna decidere se il core resta raw-first, diventa record-first o usa un bridge misurato. | Inotify reference backend MVP closure audit, Backend API v0 staged, Event Model v0, Writer Runtime v0, Performance suite v0, JSONL/session metadata. | Decisione esplicita sul core input model, piano di migrazione del main loop, benchmark gate per il percorso caldo e base piu' pulita per fanotify/audit/eBPF futuri. Rimandati: nuovi backend, Agent Guard, policy/enforcement, registry multi-backend e worker/per-sink queues. | [Milestone #11](https://github.com/kinderp/alfred/milestone/11), [Issue #187](https://github.com/kinderp/alfred/issues/187), [Issue #188](https://github.com/kinderp/alfred/issues/188) | [48](48-core-input-main-loop-migration-v0.md), [31](31-milestone-inotify-reference-backend.md), [30](30-backend-api-v0.md), [29](29-event-model-v0.md), [33](33-writer-runtime-roadmap-v0.md), [34](34-report-benchmark-prestazioni.md), [47](47-inotify-reference-backend-mvp-closure-audit.md) |
