...
| 12 | [MVP operational usability v0](49-mvp-operational-usability-v0.md) | done | 2026-07-17 -> 2026-07-17 UTC | Circa 1 settimana | Circa 1 giorno | Dopo la decisione raw-first sul core input model non conveniva riaprire subito il percorso caldo o partire con nuovi backend. Il rischio piu' vicino era operativo: l'MVP esisteva, ma un utente doveva ancora capire facilmente CLI, config, log, JSONL e smoke test. La milestone ha chiuso quel gap senza cambiare runtime. | Inotify reference backend MVP closure audit, Core Input Model / Main Loop Migration v0, Event Model v0, Backend API v0 staged, Writer Runtime v0, JSONL/session metadata. | CLI minima documentata e testata, README e man page inglesi allineati, README/man page italiane locali, smoke test MVP, readiness audit e base piu' solida prima di fanotify/eBPF/audit o Agent Guard. Rimandati: parser CLI completo, packaging man page, nuovi backend, policy/enforcement, worker thread, core record-first e Universal Observation Runtime. | [Milestone #12](https://github.com/kinderp/alfred/milestone/12), [Issue #209](https://github.com/kinderp/alfred/issues/209), [Issue #224](https://github.com/kinderp/alfred/issues/224), [PR #225](https://github.com/kinderp/alfred/pull/225) | [49](49-mvp-operational-usability-v0.md), [19](19-roadmap-cli-e-man-page.md), [26](26-stato-funzionalita.md), [48](48-core-input-main-loop-migration-v0.md), [README](../../README.md), [README.it](../../README.it.md), [man](../man/man1/alfred.1) |
| 13 | [CLI parser v0](50-cli-parser-v0.md) | done | 2026-07-17 -> 2026-07-18 UTC | Circa 1 settimana | Circa 1 giorno | Dopo la readiness MVP, il debito utente piu' vicino era il parsing esplicito degli argomenti. La milestone ha chiuso il sottoinsieme piccolo: `-c`, `--config`, `--config=FILE`, `--`, `-h`, `-V`, `--help`, `--version` e `--check-config`, senza riaprire runtime, backend o hot path. | MVP operational usability v0, roadmap CLI/man page, livello applicazione, test CLI. | CLI piu' prevedibile, config precedence testata, README/man page piu' affidabili e base migliore per packaging/uso reale senza riaprire hot path o backend futuri. Rimandati: `--print-config`, subcommand framework, daemon mode, Agent Guard, backend futuri e installazione man page. | [Milestone #13](https://github.com/kinderp/alfred/milestone/13), [Issue #228](https://github.com/kinderp/alfred/issues/228), [Issue #236](https://github.com/kinderp/alfred/issues/236), [PR #237](https://github.com/kinderp/alfred/pull/237), [Issue #238](https://github.com/kinderp/alfred/issues/238), [PR #239](https://github.com/kinderp/alfred/pull/239), [Issue #240](https://github.com/kinderp/alfred/issues/240), [PR #241](https://github.com/kinderp/alfred/pull/241), [Issue #242](https://github.com/kinderp/alfred/issues/242), [44d307f](https://github.com/kinderp/alfred/commit/44d307f373078588a0ccc80e2e5d1ed012b0cda3) | [50](50-cli-parser-v0.md), [19](19-roadmap-cli-e-man-page.md), [49](49-mvp-operational-usability-v0.md), [04](04-livello-applicazione.md), [README](../../README.md), [README.it](../../README.it.md), [alfred(1)](../man/man1/alfred.1), [alfred(1) it](../man/it/man1/alfred.1) |
| 14 | [Post-MVP documentation and man pages v0](51-post-mvp-documentation-man-pages-v0.md) | done | 2026-07-18 -> 2026-07-18 UTC | Circa 3-4 giorni | Meno di 1 giorno | Dopo `CLI parser v0`, la superficie utente era abbastanza stabile da riallineare README, README italiano, pagine man inglesi/italiane e documentazione didattica senza riaprire runtime o backend. La milestone ha chiuso quel riallineamento e una passata finale di readiness. | MVP operational usability v0, CLI parser v0, README/man page esistenti, smoke test MVP. | Documentazione pubblica piu' coerente, pagine man piu' utili, meno drift fra italiano/inglese e base migliore per packaging futuro o utenti esterni. Rimandati: `--print-config`, installazione man page, generazione automatica man page e traduzione completa `docs/en`. | [Milestone #14](https://github.com/kinderp/alfred/milestone/14), [Issue #244](https://github.com/kinderp/alfred/issues/244), [Issue #245](https://github.com/kinderp/alfred/issues/245), [PR #246](https://github.com/kinderp/alfred/pull/246), [Issue #247](https://github.com/kinderp/alfred/issues/247), [PR #248](https://github.com/kinderp/alfred/pull/248), [Issue #249](https://github.com/kinderp/alfred/issues/249), [PR #250](https://github.com/kinderp/alfred/pull/250), [Issue #251](https://github.com/kinderp/alfred/issues/251), [PR #252](https://github.com/kinderp/alfred/pull/252), [Issue #253](https://github.com/kinderp/alfred/issues/253), [PR #254](https://github.com/kinderp/alfred/pull/254), [Issue #255](https://github.com/kinderp/alfred/issues/255), [PR #256](https://github.com/kinderp/alfred/pull/256), [5c7d8b6](https://github.com/kinderp/alfred/commit/5c7d8b63ba4db19a4ac7f51d0520219022981736) | [51](51-post-mvp-documentation-man-pages-v0.md), [50](50-cli-parser-v0.md), [49](49-mvp-operational-usability-v0.md), [19](19-roadmap-cli-e-man-page.md), [README](../../README.md), [README.it](../../README.it.md), [man](../man/man1/alfred.1) |
...
| 16 | [First-user pre-release validation v0](55-first-user-pre-release-validation-v0.md) | in progress | 2026-07-19 -> 2026-07-26 UTC | Circa 1 settimana iniziale | In corso | Dopo installabilita', CLI, documentazione e CI serve osservare uso reale prima di scegliere altra architettura o feature. | Installability and Linux compatibility v0, smoke MVP, audit notturni e chiusura debito CI #276/PR #277. | Protocollo con consenso e privacy, report riproducibili, priorita' guidate da utenti, scenari reali e decisione sulla feature successiva. | [Milestone #16](https://github.com/kinderp/alfred/milestone/16), [Issue #279](https://github.com/kinderp/alfred/issues/279), [Issue #280](https://github.com/kinderp/alfred/issues/280) | [55](55-first-user-pre-release-validation-v0.md), [Audit](audit/README.md), [53](53-installability-linux-compatibility-v0.md), [35](35-qualita-prodotto-software.md) |
| 17 | [Linux userspace matrix expansion](53-installability-linux-compatibility-v0.md#roadmap-ordinata-opensuse-e-arch-linux) | future | Dopo la prima evidenza pre-release, salvo bug o richiesta utente | Circa 2-4 giornate, una lane alla volta | Non ancora nota | openSUSE e Arch aggiungono package manager e toolchain non coperti, ma non devono ritardare i primi utenti solo per aumentare il numero di lane. | Contratto lane v0, compatibility evidence v0 e risultati della validazione pre-release. | Maggiore evidenza userspace e dati per decidere successivi test VM/kernel. | [Issue #278](https://github.com/kinderp/alfred/issues/278); issue figlie e PR separate da creare per openSUSE e Arch. | [53](53-installability-linux-compatibility-v0.md) |
| 18 | [Universal Observation Runtime research](38-visione-observation-runtime.md) | future | Non pianificata | Non stimata | Non ancora nota | Serve evitare che il modello comune venga chiuso dentro filesystem/inotify se Alfred dovra' rappresentare osservazioni, inferenze, azioni e feedback. | Backend API v0 reale, almeno piu' domini/sensori, replay, projection layer minimo. | Possibile modello Observation, knowledge graph, world model digitale, agenti e LLM come adapter/interfaccia. | Da creare solo quando diventa lavoro operativo. | [39](39-principi-architetturali-futuri.md), [24](24-roadmap-ai-agent-guardrail.md) |
...
1. chiudere il debito runtime/pinning delle GitHub Actions con
   ...
   [PR #277](https://github.com/kinderp/alfred/pull/277): completato;
2. eseguire come lavoro di prodotto corrente la validazione pre-release con
   primi utenti e scenari reali tramite la
   [Milestone #16](https://github.com/kinderp/alfred/milestone/16), usando i
   risultati per scegliere la feature successiva;
