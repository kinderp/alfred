...
| Golden test JSONL end-to-end | `make test-jsonl` | Primo scenario supportato | Verifica `output.jsonl` con parsing JSON reale per create file, create directory e `WATCH_ADDED`; da estendere a rename/move, recovery ed errori |
