...
| Backend API v0 | Documentata, primo tipo record, adapter raw, adapter semantico, builder diagnostico e formatter testuale implementati | Specifica in `30-backend-api-v0.md`; manca refactor inotify a `emit(record)` |
