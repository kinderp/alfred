...
| Backend API v0 | Documentata, primo tipo record e adapter raw implementati | Specifica in `30-backend-api-v0.md`; mancano builder diagnostici, writer e refactor inotify a `emit(record)` |
