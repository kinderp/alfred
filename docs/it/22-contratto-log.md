...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Watch lifecycle | `WATCH_ADDED`, `WATCH_REMOVED`, `WATCH_STALE`, `WATCH_STALE_EVENT_DROPPED` | `events.log` | si | si | parziale | no | uniformare tutti i call site su record diagnostic e inviarli alla pipeline |
