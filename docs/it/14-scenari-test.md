...
| attrib raw log | `tests/backend/test_attrib_raw_log.sh` | `IN_ATTRIB` nel raw log dopo `chmod` | verifica che la maschera osservi cambiamenti di attributi senza introdurre ancora una semantica core |
