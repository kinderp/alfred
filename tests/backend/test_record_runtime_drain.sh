...
cc -D_DEFAULT_SOURCE -D_POSIX_C_SOURCE=200809L -Wall -Wextra -std=c11 \
    ...
    "$ROOT_DIR/tests/backend/test_record_runtime_drain.c" \
    ...
    -o "$BUILD_DIR/alfred_test_record_runtime_drain"

"$BUILD_DIR/alfred_test_record_runtime_drain"

echo "PASS backend record runtime drain"
