...
TEST_BIN="$BUILD_DIR/test_onlydir_rejects_file_root"
...
gcc \
    ...
    "$ROOT_DIR/tests/backend/test_onlydir_rejects_file_root.c" \
...
echo "PASS backend IN_ONLYDIR rejects file root"
