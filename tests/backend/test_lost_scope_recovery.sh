...
TEST_BIN="$BUILD_DIR/test_lost_scope_recovery"
TEST_ROOT="${TEST_ROOT:-/tmp/alfred_lost_scope_recovery_test}"
...
gcc \
    ...
    "$ROOT_DIR/tests/backend/test_lost_scope_recovery.c" \
...
echo "PASS backend lost scope recovery"
