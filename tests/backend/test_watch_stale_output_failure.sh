...
TEST_BIN="$BUILD_DIR/test_watch_stale_output_failure"
...
gcc \
    ...
    "$ROOT_DIR/tests/backend/test_watch_stale_output_failure.c" \
...
echo "PASS backend WATCH_STALE output failure"
