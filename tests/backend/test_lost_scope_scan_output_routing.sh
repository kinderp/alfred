...
TEST_BIN="$BUILD_DIR/test_lost_scope_scan_output_routing"
...
gcc \
    ...
    "$ROOT_DIR/tests/backend/test_lost_scope_scan_output_routing.c" \
...
echo "PASS backend WATCH_LOST scan output routing"
